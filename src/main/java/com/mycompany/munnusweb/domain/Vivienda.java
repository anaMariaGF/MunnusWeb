...
public class Vivienda implements Serializable {
	...
	@OneToMany(mappedBy = "vivienda")
	private List<ViendaPropietario> propietarioCollection;
	...
	public Collection<ViendaPropietario> getPropietarioCollection() {
		return propietarioCollection;
	}

	public void setPropietarioCollection(List<ViendaPropietario> propietarioCollection) {
