...
public class Encriptador {
    ...
    //1= 1 2 = 2 3 =3 4 = 4 5= 0 6 = 1 7 8 9 10 % 5 puede pasar que dos usuarios tenga el mismo hash
    /*El método "comparadorMD5" se encarga de comparar la contraseña ingresada 
    por el usuario con la contraseña encriptada almacenada en la base de datos. */
