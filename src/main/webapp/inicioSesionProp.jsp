<%-- 
    ...
    Created on : 23-feb-2023, 1:46:22
    Author     : ana
--%>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-md-6 form-container">
              <form action="/inicioSesion?rol=prop" method="post">
            <div class="col-md-6 form-container">
              <div class="form-group">
                <input type="text" name="email" class="form-control form-control-sm" placeholder="Email" id="email" aria-describedby="emailHelp">
              </div>
            </div>
            <div class="col-md-6 form-container">
              <div class="form-group">
            ...
            <div class="col-md-6 form-container ">
              ...
              <div class="sign-up">
                No tienes una cuenta aún? <a href="/formProp.jsp">Crear cuenta</a>
              </div>
            </form>
